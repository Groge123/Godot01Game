...
@export var max_health_base: int = 10        # 基础最大生命值
...
# 加成
var max_health_add: int = 0          # 最大生命值加成
var attack_add: int = 0              # 攻击力加成
var move_speed_add: float = 0        # 移动速度加成
var shield_add: int = 0              # 护盾值加成
var critical_rate_add: float = 0     # 暴击率加成

@export var equip_radius=100
@export var equip_max=3

@export var attack_speed_buff=1
