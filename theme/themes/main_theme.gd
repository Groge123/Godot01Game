...
const THEME_FILE_PATH ="res://theme/themes/main_theme.tres"
...
const UI_PACK_COLOR_PATH = "res://theme/themes/ui_pack/%s/%s.svg"
const UI_PACK_EXTRA_PATH = "res://theme/themes/ui_pack/extra/%s.svg"
